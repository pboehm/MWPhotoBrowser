...
- (void)globalActionButtonPressed:(id)sender {
    if ([_delegate respondsToSelector:@selector(photoBrowser:gridActionButtonPressedWithSender:)]) {
        [_delegate photoBrowser:self gridActionButtonPressedWithSender:sender];
    }
}
